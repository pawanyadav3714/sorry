    ...
    ],
{
    ...
    aud2.play();
    aud2.volume = 0.2;
        h1.innerHTML = "<p>waise v ab mai chla jaaunga n Dhani! bs kuch din aur aapke town me🥺 </p>";
    ...
    ],
{
    ...
    aud2.pause();
        ...
        h3.innerHTML = "<p>ab kitna code krwaogi mere se??🥺</p>";
...
yes.addEventListener("click", function handleYES(){
    ...
    aud1.pause();
    aud2.pause();
    h1.innerHTML = "<h1>Thanku Dhani..Aap bohot achhe ho🥰</h1>";
